...
: > "$log_file"  # Truncates log_file to empty it
...
# Run the sanity check for HON17873
process_vehicle_id "$vehicle_id"

echo "Sanity check complete. Check $log_file for details."
