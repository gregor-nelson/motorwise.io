    ...
    constructor() {
        ...
        this.loader.load([
            ...
            // Intro
            {
                ...
                source: './models/intro/static/base.glb'
            },
            {
...

            {
                ...
                source: './models/intro/arrowKey/base.glb'
            },
            {
            ...
            {
                name: 'introBBase',
                source: './models/intro/b/base.glb'
            },
            {
                name: 'introBCollision',
                source: './models/intro/b/collision.glb'
            },

            {
                name: 'introRBase',
                source: './models/intro/r/base.glb'
            },
            {
                name: 'introRCollision',
                source: './models/intro/r/collision.glb'
            },

            {
                name: 'introUBase',
                source: './models/intro/u/base.glb'
            },
            {
                name: 'introUCollision',
                source: './models/intro/u/collision.glb'
            },

            {
                name: 'introNBase',
                source: './models/intro/n/base.glb'
            },
            {
                name: 'introNCollision',
                source: './models/intro/n/collision.glb'
            },

            {
                name: 'introOBase',
                source: './models/intro/o/base.glb'
            },
            {
                name: 'introOCollision',
                source: './models/intro/o/collision.glb'
            },

            {
                name: 'introSBase',
                source: './models/intro/s/base.glb'
            },
            {
                name: 'introSCollision',
                source: './models/intro/s/collision.glb'
            },

            {
                name: 'introIBase',
                source: './models/intro/i/base.glb'
            },
            {
                name: 'introICollision',
                source: './models/intro/i/collision.glb'
            },

            {
                name: 'introMBase',
                source: './models/intro/m/base.glb'
            },
            {
                name: 'introMCollision',
                source: './models/intro/m/collision.glb'
            },

            {
                name: 'introCreativeBase',
                source: './models/intro/creative/base.glb'
            },
            {
            ...
            {
                name: 'introDevBase',
                source: './models/intro/dev/base.glb'
            },
            {
                name: 'introDevCollision',
                source: './models/intro/dev/collision.glb'
            },
            ...
            // Car default
            {
                ...
                source: './models/car/default/chassis.glb'
            },
            {
                name: 'carDefaultWheel',
                source: './models/car/default/wheel.glb'
            },
            {
            ...
            },
            {
                ...
                source: './models/car/default/antena.glb'
            },
            ...
            {
                name: 'brickBase',
                source: './models/brick/base.glb'
            },
            {
                name: 'brickCollision',
                source: './models/brick/collision.glb'
            },

            // Horn
            {
                name: 'hornBase',
                source: './models/horn/base.glb'
            },
            {
                name: 'hornCollision',
                source: './models/horn/collision.glb'
            },
            ...
            // Webby trophy
            {
                ...
                source: './models/webbyTrophy/base.glb'
            },
            {
            ...
            {
                name: 'lemonBase',
                source: './models/lemon/base.glb'
            },
            {
                name: 'lemonCollision',
                source: './models/lemon/collision.glb'
            },

            // Bownling ball
            {
                name: 'bowlingBallBase',
                source: './models/bowlingBall/base.glb'
            },
            {
            ...
            {
                name: 'bowlingPinBase',
                source: './models/bowlingPin/base.glb'
            },
            {
            ...
            {
                name: 'areaEnter',
                source: './models/area/enter.png',
                type: 'texture'
            },
            {
                name: 'areaOpen',
                source: './models/area/open.png',
                type: 'texture'
            },
            {
                name: 'areaReset',
                source: './models/area/reset.png',
                type: 'texture'
            },
            {
            ...
            },
            {
                ...
                source: './models/tiles/b/collision.glb'
            },
            ...
            },
            {
                ...
                source: './models/tiles/c/collision.glb'
            },
            ...
            },
            {
                ...
                source: './models/tiles/d/collision.glb'
            },
            ...
            },
            {
                ...
                source: './models/tiles/e/collision.glb'
            },
            ...
            {
                name: 'wig1',
                source: './models/wigs/wig1.glb'
            },
            {
                name: 'wig2',
                source: './models/wigs/wig2.glb'
            },
            {
                name: 'wig3',
                source: './models/wigs/wig3.glb'
            },
            {
                name: 'wig4',
                source: './models/wigs/wig4.glb'
            },
