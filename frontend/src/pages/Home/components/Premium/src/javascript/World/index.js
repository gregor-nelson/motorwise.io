...
export default class World {
    ...
    setReveal() {
        ...
        this.reveal.go = () => {
            ...
            if (this.sections.intro) {
                gsap.fromTo(this.sections.intro.instructions.arrows.label.material, {
                    opacity: 0
                }, {
                    opacity: 1,
                    duration: 0.3,
                ...
                if (this.sections.intro.otherInstructions) {
                    gsap.fromTo(this.sections.intro.otherInstructions.label.material, {
                        opacity: 0
                    }, {
                        opacity: 1,
                        duration: 0.3,
            ...
            // Sound
            gsap.fromTo(this.sounds.engine.volume, {
                master: 0
            }, {
                master: 0.7,
                duration: 0.5,
    ...
    setStartingScreen() {
        ...
        this.startingScreen.area.on('interact', () => {
            ...
            gsap.to(this.startingScreen.area.floorBorder.material.uniforms.uProgress, {
                value: 0,
                duration: 0.3,
                delay: 0.4
            })
